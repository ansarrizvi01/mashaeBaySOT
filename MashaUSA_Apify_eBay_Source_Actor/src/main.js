...
const {startUrls=[],maxConcurrency=3,maxRequestsPerCrawl=0,waitAfterLoadMs=1200,navigationTimeoutSecs=45,requestHandlerTimeoutSecs=75,saveFailureSnapshots=false,proxyConfiguration:proxyInput={useApifyProxy:true,groups:['RESIDENTIAL'],countryCode:'US'}}=input;
...
const crawler=new PlaywrightCrawler({
 ...
 navigationTimeoutSecs,requestHandlerTimeoutSecs,maxRequestRetries:2,
